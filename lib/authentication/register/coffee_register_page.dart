...
class CoffeeRegisterPage extends StatefulWidget {
  final User? user;
  const CoffeeRegisterPage({Key? key, this.user}) : super(key: key);

  @override
  State<CoffeeRegisterPage> createState() => _CoffeeRegisterPageState();
}

class _CoffeeRegisterPageState extends State<CoffeeRegisterPage> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding:  widget.user == null ? EdgeInsets.all(0.sp): EdgeInsets.symmetric(horizontal: 20.sp),
                    child: Column(
                      children: [
                        widget.user != null ? AppSize.h40.ph: const SizedBox(),
                        CustomField(
                        ...
                        widget.user == null? CustomField(
                          ...
                          fillColor: AppColors.kTextFieldColor,
                          suffix: IconButton(
                            icon: isHidden? const Icon(Icons.visibility_off_outlined):
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    widget.user != null ? AppSize.h40.ph: SizedBox(),
                    CustomField(
                      controller: viewModel.name,
                      fillColor: AppColors.kTextFieldColor,
                      hint: "Name",
